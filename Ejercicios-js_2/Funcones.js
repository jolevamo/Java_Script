...
//Ejercicio 10:
 ...
 function Capt_Product (){
    for(a=1;a<=n;a++){
       Nombre_Product = prompt("Ingrese el nombre del producto "+a+": ");
       Val_Product = prompt("Ingrese el valor del producto"+a+": ");
    }
 }
 Capt_Product();
 function Impri_Produ (){
     for(a=1;a<=n;a++){
        document.write("<p>"+"Producto "+a+" :"+Nombre_Product+"</p>");
        document.write("<p>"+"Valor "+a+" :"+Val_Product+"</p>");
     }
 }
Impri_Produ();
